...
class PhoneAuthDataProvider with ChangeNotifier {
  ...
  var _authCredential;
  String _actualCode;
  String _phone, _message, _userId;
  ...
  _startAuth() {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      print("failed with error : ${authException.message}'");
    ...
    final PhoneVerificationCompleted verificationCompleted =
      ...
      FirebaseAuth.instance.signInWithCredential(auth).then((value) {
        // if (value.user != null) {
        if (value.user != null) {
          _userId = value.user.uid;
          print(_userId);
          // _userId = value.additionalUserInfo.providerId;
          notifyListeners();
  ...
  void verifyOTPAndLogin({String smsCode}) async {
    ...
    FirebaseAuth.instance.signInWithCredential(_authCredential).then((result) async {
      _addStatusMessage('Authentication successful');
      _addStatus(PhoneAuthState.Verified);
      if (onVerified != null) onVerified();
      // _userId = result.additionalUserInfo.providerId;
