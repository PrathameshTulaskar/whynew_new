...
class ProductStatus extends StatefulWidget {
  ProductStatus({Key key}) : super(key: key);
      ...
      child: Scaffold(
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              BackButtonCustom(),
              PageLabel(label: "Product Status"),
              ...
              Column(
                children:List<Widget>.generate(appState.productDetails.length,(index)
                {
                  return  OrderTile(
                amount: appState.productDetails[index].price,
               orderStatus:appState.productDetails[index].status==true ? 1 : 2,
                // orderStatus: if(appState.productDetails[index].status==true ){
                //   orderStatus=1
                // },else{
                //   orderStatus=2
                // }
                productTitle: appState.productDetails[index].productName,
                productUrl: appState.productDetails[index].imgUrl,
                time: appState.productDetails[index].productAddedOn.toString(),
...
class OrderTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String orderStatusValue =  orderStatus == 1 ? "Approved" : orderStatus == 2 ? "Pending" : "Decline";
    return InkWell(
