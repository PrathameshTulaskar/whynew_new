...
import 'addRegistrationDetail.dart';
...
class PhoneAuthVerify extends StatefulWidget {
   ...
   */
  final Color cardBackgroundColor = Colors.deepPurple[200];
  // final String logo = Assets.firebase;
  final String appName = "WhyNew";
...
class _PhoneAuthVerifyState extends State<PhoneAuthVerify> {
  ...
  Widget build(BuildContext context) {
    final phoneProvider = Provider.of<PhoneAuthDataProvider>(context);
    ...
    phoneAuthDataProvider.setMethods(
      ...
      contactNumber: phoneProvider.phone,
      identifier: "phone",
      userId: phoneProvider.userId
    );
    print("${phoneProvider.userId} This is user ID ${phoneProvider.phone}");
    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(
      ...
      //onVerified(phoneProvider.phone,phoneProvider.userId),
              ...
              Expanded(
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'OTP will be sent on your phone shortly',
                        style: TextStyle(
...
//    _showSnackBar(phoneAuthDataProvider.message);
  ...
  void onVerified(String phoneNumber,String userId) async {
    ...
    // .pushNamedAndRemoveUntil('/addregistration', (Route<dynamic> route) => false,arguments: loginData);
  ...
  onFailed() {
    //rint("${phoneAuthDataProvider.message}" ?? "");
//    _showSnackBar(phoneAuthDataProvider.message);
